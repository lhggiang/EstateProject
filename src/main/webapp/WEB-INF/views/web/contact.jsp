            ...
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    <h2 class="title-lienhe"><strong>Liên hệ với chúng tôi</strong></h2>
                        <form:form modelAttribute="infoContact" action="${contactURL}" id="contactForm" method="GET">
                        <div class="row">
                            <div class="col">
                                <form:input path="fullName" id="name" cssClass="form-control" placeholder="Họ và tên" />
                            </div>
                            <div class="col">
                                <form:input path="email" id="email" cssClass="form-control" placeholder="Email"/>
                            </div>
                        </div>
                            <form:input path="phoneNumber" id="customerPhone" cssClass="form-control" placeholder="Số điện thoại"/>
                            <form:input path="demand" cssClass="form-control" placeholder="Nội dung"/>
                            <input type="button" class="btn btn-primary px-4 mt-3" value="Gửi liên hệ"
...
<script type="application/javascript">
    $('#addCustomerContact').click(function (e) {
        e.preventDefault();
        var data = {};
